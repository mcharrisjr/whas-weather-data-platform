...
from whas_weather_data_platform.hourly_forecast.scrape import scrape
...
def test_scrape(weather_soup: Tag) -> None:
    ...
    with (
        patch.object(
            scrape_module, "parse_hourly_weather_forecasts", autospec=True
        ) as mock_parse,
        patch.object(
        ...
        mock_put_forecasts.assert_called_once_with(
            ...
            forecast_frequency=WeatherDataFrequency.HOURLY,
        )
